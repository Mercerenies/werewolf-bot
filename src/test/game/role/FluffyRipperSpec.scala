...
class FluffyRipperSpec extends GameplayUnitSpec {
  ...
  it should "ask for input from a solo Fluffy" in {
    val board = createBoard(
      left = Villager,
      middle = Villager,
      right = Tanner,
  ...
  it should "ask for input from a solo Ripper" in {
    val board = createBoard(
      left = Villager,
      middle = Villager,
      right = Tanner,
  ...
  it should "ask for no input from a Fluffy/werewolf team" in {
    val board = createBoard(
      left = Villager,
      middle = Villager,
      right = Tanner,
      playerCards = List(Villager, Fluffy, Werewolf),
    )
    val (finalBoard, _, feedback, _) = playGame(board, List("", "none", ""))
    finalBoard should be (board)
  ...
  it should "ask for no input from a Ripper/werewolf team" in {
    val board = createBoard(
      left = Villager,
      middle = Villager,
      right = Tanner,
      playerCards = List(Villager, Ripper, Werewolf),
    )
    val (finalBoard, _, feedback, _) = playGame(board, List("", "none", ""))
    finalBoard should be (board)
  ...
  it should "ask for no input from a Fluffy/Ripper/werewolf team" in {
    val board = createBoard(
      left = Villager,
      middle = Villager,
      right = Tanner,
      playerCards = List(Villager, Fluffy, Ripper, Werewolf),
    )
    val (finalBoard, _, feedback, _) = playGame(board, List("", "none", ""))
    finalBoard should be (board)
    ...
    finalBoard(id(1)).nightHandler should be (NoInputNightMessageHandler)
    finalBoard(id(2)).nightHandler should be (NoInputNightMessageHandler)
    finalBoard(id(3)).nightHandler should be (NoInputNightMessageHandler)
